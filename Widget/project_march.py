...
class Ui_Project(object):
    def setupUi(self, Project):
        ...
        self.label.setGeometry(QtCore.QRect(40, 40, 211, 61))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/Images/Static/LogoMakr-0NnMg3.png"))
...
"background-color:  #1589FF;")
        ...
        self.label_5.setGeometry(QtCore.QRect(40, 40, 211, 61))
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap(":/Images/Static/LogoMakr-0NnMg3.png"))
...
"background-color:  #1589FF;")
        ...
        self.label_17 = QtWidgets.QLabel(self.signup_page)
        self.label_17.setGeometry(QtCore.QRect(40, 40, 211, 61))
        self.label_17.setText("")
        self.label_17.setPixmap(QtGui.QPixmap(":/Images/Static/LogoMakr-0NnMg3.png"))
...
"background-color: #123456;")
        ...
        self.nom_line_2.setGeometry(QtCore.QRect(990, 30, 341, 41))
        self.nom_line_2.setStyleSheet("background-color: #F8F6F0;")
        self.nom_line_2.setText("")
        self.nom_line_2.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.nom_line_2.setObjectName("nom_line_2")
        self.label_14 = QtWidgets.QLabel(self.frame_3)
        self.label_14.setGeometry(QtCore.QRect(10, 20, 211, 61))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Images/Static/account_32px.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(920, 20, 71, 61))
        self.pushButton_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_2.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/Images/Static/search_24px.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color:  #FD1C03;")
    ...
    def retranslateUi(self, Project):
        ...
        self.label_3.setText(_translate("Project", "<html><head/><body><p>Inscrivez-vous pour apprendre les bases de la</p><p> programmation avec Code Breaker gratuitement</p></body></html>"))
